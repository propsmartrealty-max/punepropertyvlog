            ...
            >
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center">
                        ...
                        {/* Desktop Links */}
                        <div className="hidden md:flex items-center gap-1 bg-white/5 backdrop-blur-sm px-2 py-1 rounded-full border border-white/10 shrink-0">
                        ...
                        <div className="flex items-center gap-3 shrink-0">
                            <a href="https://wa.me/917744009295" target="_blank" rel="noopener noreferrer" className={`hidden md:flex items-center gap-2 px-3 lg:px-4 py-2 rounded-full font-bold text-sm transition-all ${scrolled ? 'bg-green-50 text-green-700 hover:bg-green-100 shadow-sm' : 'bg-green-500/20 text-white hover:bg-green-500/30 backdrop-blur-sm border border-green-400/30'
                                }`}>
                            ...
                            <a href="tel:+917744009295" className={`hidden md:flex items-center gap-2 px-3 lg:px-4 py-2 rounded-full font-bold text-sm transition-all ${scrolled ? 'bg-slate-100 text-slate-900 hover:bg-slate-200' : 'bg-white/10 text-white hover:bg-white/20 backdrop-blur-sm border border-white/10'
                                }`}>
