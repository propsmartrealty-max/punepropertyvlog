...
const BuilderForm = () => {
    ...
    // Robust Upload Tracking: Track specific fields
    const [uploadingFields, setUploadingFields] = useState<Record<string, boolean>>({});
    const isUploading = Object.values(uploadingFields).some(Boolean);

    // Helper to update upload status per field
    ...
    useEffect(() => {
        if (isEditing && id) {
            ...
            // Only update if we found a builder and it's different from current state
    ...
    const handleChange = (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => {
        // ... (existing handleChange logic omitted for brevity, it's fine)
