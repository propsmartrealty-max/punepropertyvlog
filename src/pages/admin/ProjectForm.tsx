...
const ProjectForm = () => {
    ...
    useEffect(() => {
        if (isEditing && id) {
            ...
            if (project) {
                // Sanitize data to prevent crashes on null arrays
                setFormData({
                    ...project,
                    ...
                    advancedConfigurations: project.advancedConfigurations || []
                });
                setAiQuery(project.title);
            }
        } else {
        ...
        try {
            ...
            if (data.builderId) {
                ...
                if (matchedBuilder) {
                    ...
                    toast.success(`Matched builder: ${matchedBuilder.name}`);
                } else {
                    ...
                    toast('Builder not found in database. Please add it first if needed.', { icon: '⚠️' });
                }
            }
            toast.success('Project details fetched from AI!');
        ...
        <AdminLayout title={isEditing ? 'Edit Project' : 'Add New Project'}>
            <div className="max-w-3xl mx-auto">
                ...
                <form onSubmit={handleSubmit} className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 space-y-6">
                    <fieldset disabled={isSaving} className="contents group-disabled:opacity-50">
