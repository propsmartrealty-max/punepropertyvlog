...
const ProjectForm = () => {
    ...
    const { projects, builders, addProject, updateProject } = useData();
    const isEditing = !!id;
        ...
        try {
            ...
            if (data.builderId) {
                ...
                const matchedBuilder = builders.find(b =>
                    ...
                    data.builderId!.toLowerCase().includes(b.name.toLowerCase())
                );
                if (matchedBuilder) {
                ...
                <form onSubmit={handleSubmit} className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input name="location" value={formData.location} onChange={handleChange} required className="w-full px-4 py-2 border rounded-lg" />
                        </div>
                    </div>
